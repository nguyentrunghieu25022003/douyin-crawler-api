...
class MsToken:
    ...
    def get_fake_ms_token(key="msToken", size=156) -> dict:
        """
        Generate a random string of given size using digits, uppercase and lowercase letters.
        """
    ...
    async def _get_ms_token(
        ...
        **kwargs,
        ...
        return TtWid.extract(response.headers, cls.NAME)
